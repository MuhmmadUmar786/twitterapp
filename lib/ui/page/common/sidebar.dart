            ...
            Padding(
              ...
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  _menuListRowButton('Go Live', icon: AppIcon.camera,
                    isEnable: true,
                    onPressed: () {
                      Navigator.push(context, BookmarkPage.getRoute());
                    },
                  ),
                  _menuListRowButton('Create Group', icon: Icons.group_add,isEnable: true),
                  _menuListRowButton('Predict markets', icon: AppIcon.lists,isEnable: true),
